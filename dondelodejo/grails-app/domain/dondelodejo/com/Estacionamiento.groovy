...
class Estacionamiento {
	...
	def getCantidadCocherasLibres(){
		//cocheras es un set
		this.cocheras.findAll{ cochera ->
			cochera.estado==Cochera.ESTADO_LIBRE
		}.size()
...
class Ubicacion {
	...
	static constraints = {
		...
		//poner como default nos ahorrar� tiempo de desarrollo
	...
	public static Map buscar(String direccion,String localidad,String pais){
		...
		try {
			...
			LoggerService.Log("Error Codificaci�n geogr�fica")
		}
		[x:CoordX,y:CoordY]
	}
